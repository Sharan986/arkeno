...
const AboutSection: React.FC = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 relative bg-[#0C0C0C]">
      {/* Decorative images */}
      ...
      <div className="flex flex-col items-center z-10">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
          ...
          <AnimatedText
            text="We are Arkeno, an elite team of developers and architects. We specialize in building scalable, high-performance web applications and immersive digital experiences that elevate brands and drive results. Let's build the future together."
