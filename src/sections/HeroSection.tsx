  ...
  return (
    <section className="h-screen flex flex-col relative" style={{ overflowX: 'clip' }}>
      ...
      <FadeIn delay={0.15} y={40} className="overflow-hidden">
        <h1
          className="hero-heading font-black uppercase tracking-tighter leading-none whitespace-nowrap w-full text-[8.5vw] sm:text-[9vw] md:text-[10vw] lg:text-[11vw] mt-6 sm:mt-4 md:-mt-5 px-6 md:px-10"
        >
          We build the web
        </h1>
      </FadeIn>
      ...
      <div className="mt-auto flex justify-between items-end pb-7 sm:pb-8 md:pb-10 px-6 md:px-10">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            an elite development studio crafting high-performance digital experiences
          </p>
        </FadeIn>
